...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clk_wiz_720p_clk_wiz is
  ...
  signal clk_out_100MHz_clk_wiz_720p : STD_LOGIC;
  signal clk_out_100MHz_clk_wiz_720p_en_clk : STD_LOGIC;
...
\seq_reg3_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out_100MHz_clk_wiz_720p_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg3(0),
      R => '0'
